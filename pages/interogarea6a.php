...
include "connect.php";
			...
			{
				$result="call interogarea6a1";
				$rezultate_cautare = $db->query($result);
					
			}
			else {
				$result="call interogarea6a2";
				$rezultate_cautare = $db->query($result);
			}
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading" align="center">Sa se gaseasca pentru fiecare nume de avocat numarul contractelor juridice.</header>
			...
			<table border="1" align="center" >
					<tr align="center">
						<th>NUME AVOCAT</th>
						<?php if(isset($_POST['cautare1'])) {echo '<th>NUMAR CONTRACTE</th>';} 
						?>
					</tr>
					...
					<tr align="center">
						...
						<?php if(isset($_POST['cautare1'])) {echo '<td>'.$row['nr_contracte'].'</td>';}?>
					</tr>
					<?php endwhile;?>
			 </table>
