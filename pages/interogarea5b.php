...
include "connect.php";
			...
			{
				$result="call interogarea5b1";
				$rezultate_cautare = $db->query($result);
					
			}
			else {
				$result="call interogarea5b2";
				$rezultate_cautare = $db->query($result);
			}
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading" align="center">Sa se gaseasca numele clientilor care au exact un contract de asistenta juridica.</header>
			...
			<table border="1" align="center" >
					...
					<tr align="center">
						...
						<td><?php echo $row['nr_contracte'];?></td>
					</tr>
					<?php endwhile;?>
			 </table>
          ...
          <figcaption><?php printf("Numar de clienti gasiti %d ",$rezultate_cautare->num_rows);?></figcaption>
        </figure>
      </div>
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ -->
